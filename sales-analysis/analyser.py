...
if os.path.exists(data_path):
    ...
    print(f"❌ Cannot find {data_path}")
    print("Make sure you're running from the python-aiml folder!")



#complete code for sales-analysis/analyser.py
...
# CSV
df = pd.read_csv('output/sales_with_totals.csv')
